...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4)
import itertools
...
permProp  = (lambda perm : perm.avoids([_sage_const_4 ,_sage_const_3 ,_sage_const_2 ,_sage_const_1 ]) and perm.avoids([_sage_const_4 ,_sage_const_3 ,_sage_const_1 ,_sage_const_2 ]))
permCount = (lambda n : len(filter(lambda x : permProp(x), Permutations(n))) )
overl     = (lambda n : _sage_const_1 )
compl     = (lambda n : _sage_const_1 )
atoms     = [Permutation([])]
