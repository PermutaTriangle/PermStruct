...
class OverlayGeneratingRule(PermutationSet):
    """A permutation set containing all permutations generated by a generating
    rule."""

    def __init__(self, rule, overlay, description=None):
        super(OverlayGeneratingRule, self).__init__(description=description)
        ...
        # overlay is of the form [ (set((x, y), ..), set(permutation)), ... ]
...
from permstruct import X, N, P, empty
from permstruct.lib import Permutation, generate_of_length
from permstruct.permutation_sets import SimpleGeneratingRule
...
print(generate_of_length(6, G, empty))
