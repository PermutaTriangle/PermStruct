...
patts = [Permutation([3,2,1]), Permutation([2,1,3,4]), Permutation([2,1,4,3]), Permutation([2,3,1,4]), Permutation([2, 3, 4, 1]), Permutation([2, 4, 1, 3]), Permutation([3, 1, 2, 4]), Permutation([4, 1, 2, 3])]
# The dag
max_len_patt = None
upper_bound  = None
remove       = False
